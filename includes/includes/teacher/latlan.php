<html lang="en" lang="he" dir="rtl">

<head>
	<!--load css-->
	<link rel="stylesheet" type="text/css" href="../css/style.css">
	<link rel="stylesheet" type="text/css" href="../css/cssshelter.css">
	...
	<main>
		...
		<form action="formtoserver.php" method="post">
			...
			<table class="table table-hover table-bordered">
				...
				<tr>
					<td> <label for = "exp">(בשנים)ותק</label></td>
				...
				<tr>
					...
					<td>
						<fieldset>
							<label><input type="checkbox" name="lesson[]" value="מתמטיקה א">
                        מתמטיקה א</label><br>

							<label><input type="checkbox" name="lesson[]" value=״מבני נתונים״>
                        מבני נתונים</label><br>

							<label><input type="checkbox" name="lesson[]" value="Java">
                        Java</label><br>

							<label><input type="checkbox" name="lesson[]" value="C++">
                        C++</label><br>

							<label><input type="checkbox" name="lesson[]" value="קיימות">
                        קיימות</label>
						</fieldset>
					</td>
				</tr>
