		...
		<div class="container ">
			<div class="row">
				...
				<div class="col-lg-12 col-xs-12">
								...
								<div class="row rtl col-xs-12">
									<div class="col-lg-9 col-xs-9 rtl">
										<div class=" tabs d-flex flex-row align-items-center justify-content-start rtl">
											...
											<div class="tab"><a style="text-decoration: none; color:black;" href = "myLessonsStudent.php">השיעורים שלי</a></div>
                    ...
                    <form action = "bothProfiles/update_user_data.php" onsubmit="return checkGender()" method = post>
...
<script>
    function checkGender(){
        if (document.getElementById('gender').value != "female" && document.getElementById('gender').value != "male"){
            alert ("אנא הכנס מין נכון. male לבן, female לבת.");
            return false;
        }
    }
</script>
