				...
				<div class="row">
					<div class="col">
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
                            ...
                            <!-- <button type="button" class="btn btn-primary registerButton" data-toggle="modal" data-target="#registerModal">הירשם</button> -->
                            ...
                            <div class="btn-group dropleft">
                              ...
                              <div class="dropdown-menu">
                                <a class="dropdown-item" href="includes/teacher/latlan.php">הירשם כמורה</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="includes/register_student.html">הירשם כתלמיד</a>
                              </div>
                            </div>                       
	...
	<div class="menu d-flex flex-column align-items-end justify-content-start text-right menu_mm trans_400">
		...
		<nav class="menu_nav">
			<ul class="menu_mm">
                ...
                <li class="dropdown">
                   <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">הירשם  <span class="caret"></span></a>
                    <ul class="dropdown-menu" role="menu">
                       <li><a href="includes/teacher/latlan.php">הירשם כמורה</a></li>
                       <li class="divider"></li>
                       <li><a href="includes/register_student.php">הירשם כתלמיד</a></li>
                    </ul>
                </li>
